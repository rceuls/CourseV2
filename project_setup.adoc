...
3. Je krijgt de volgende tekst: `Required assets to build and debug are missing from 'Census'. Add them?`. Beantwoord deze vraag met btn:[Yes].
...
5. Als je nu het program opstart via btn:[F5] krijg je de website te zien (met een hoop placeholder data).
